...
class PopupMenu {
  ...
  void show({ Rect? rect,  GlobalKey? widgetKey,  List<MenuItemProvider>? pItems}) {
    if (rect == null && widgetKey == null) {
      print("'rect' and 'key' can't be both null");
      return;
    } 

    this.items = pItems ?? this.items;
...
//        },
        ...
        child: Container(
          ...
          children: <Widget>[
            // triangle arrow
            Positioned(
              left:   (_showRect!.left + _showRect!.width / 2.0 - 7.5)+30,
              top: _isDown ? (offset.dy + menuHeight())+10 : (offset.dy - arrowHeight)-40,

              child: Icon(Icons.arrow_left, size: 40, color: _backgroundColor,),
              // child: CustomPaint(
            ...
            Positioned(
              left: offset.dx+70,
              top: _isDown? offset.dy+60: offset.dy-60,
              child: Container(
                width: menuWidth(),
                height: menuHeight(),
                child: Column(
...
class _MenuItemWidget extends StatefulWidget {
  ...
  // Whether to show the divider on the right
  final bool showLine;
